    ...
    <div class="container">
        <div class="section-content">
            ...
            <div class="title-wrap" data-aos="fade-up">
                ...
                <p class="section-sub-title" style="color: black; ">By making an account you have access to a lot more content.</p><br>
                <p style="color: red;">User with this email already exits!</p>
            </div>
