    ...
    <div class="container">
        <div class="section-content">
            ...
            <div class="title-wrap mb-5" data-aos="fade-up">
                ...
                <p class="section-sub-title">We are a gaming studio. But we are also memers and lazy so we usually take time to make games although we try to meet peoples exceptions.</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="testi-content testi-carousel owl-carousel">
                    <div class="testi-item text-center">
                        ...
                        <h4 class="testi-text">I have a passion for this... and memes!</h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/tkrivec1.jpg" alt="Loading...">
                            </div>
                            <div class="testi-details">
                                <p class="testi-author mb-0 font-weight-bolder">Tilen Krivec</p>
                                <p class="testi-desc mb-0">Main person/thing </p>
                            </div>
                        </div>
                    ...
                    <div class="testi-item text-center">
                        ...
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/msafaric.jpeg" alt="Loading...">
                            </div>
                            <div class="testi-details">
                                <p class="testi-author mb-0 font-weight-bolder">Maja Šafarič</p>
                                <p class="testi-desc mb-0">Artist</p>
                            </div>
                        </div>
                    </div>
                     <div class="testi-item text-center">
                        <i class="testi-icon fa fa-3x fa-quote-left"></i>
                        <h4 class="testi-text"><a href="https://www.twitch.tv/goranscorpion">https://www.twitch.tv/goranscorpion</a></h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/kjakop.jpg" alt="Loading...">
                            </div>
                            <div class="testi-details">
                                <p class="testi-author mb-0 font-weight-bolder">Klemen Jakop</p>
                                <p class="testi-desc mb-0">Story writer</p>
                            </div>
                        </div>
                    </div>
                    <div class="testi-item text-center">
                        <i class="testi-icon fa fa-3x fa-quote-left"></i>
                        <h4 class="testi-text">I want a snake...</h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/jhribersek.jpg" alt="Loading...">
                            </div>
                            <div class="testi-details">
                                <p class="testi-author mb-0 font-weight-bolder">Jure Hriberšek</p>
                                <p class="testi-desc mb-0">Sound Engine</p>
                            </div>
                        </div>
                    </div>
                    <div class="testi-item text-center">
                        <i class="testi-icon fa fa-3x fa-quote-left"></i>
                        <h4 class="testi-text">I love XXXtentacion.</h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/joštir.jpg" alt="Loading...">
                            </div>
                            <div class="testi-details">
                                <p class="testi-author mb-0 font-weight-bolder">Jani Oštir</p>
                                <p class="testi-desc mb-0">2. Sound Engine</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testi-item text-center">
                        ...
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/eplanko.jpg" alt="Loading...">
                            </div>
                            <div class="testi-details">
                                <p class="testi-author mb-0 font-weight-bolder">Emanuel Planko</p>
                                <p class="testi-desc mb-0">2. Story writer</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="section-content">
            ...
            <div class="title-wrap">
                <h2 class="section-title">Our <b>Awesome</b> Projects</h2>
                <p class="section-sub-title">It's not much BUT it's honest work.<br></p>
            </div>
            <!-- End of Section Title -->
            <div class="row">
                <!-- Portfolio Holder -->
                <div class="col-md-12 portfolio-holder mt-3">
                    ...
                    <div class="filter-button-group btn-filter d-flex justify-content-center">
                        ...
                        <a tabindex="0" data-filter=".minimalism">Mobile</a>
                        <a tabindex="0" data-filter=".vintage">PC</a>
                        <a tabindex="0" data-filter=".creative">Console</a>
                    </div>
                    <!-- End of Btn Filter -->
                    <!-- Portfolio Content -->
...
<section id="client" class="overlay bg-fixed" style="background-image: url(img/blog-2.jpg);">
    <div class="container">
        <div class="section-content" data-aos="fade-up">
            <div class="row ">
                <div class="col-md-12">
                ...
                <div class="col-md-12 client-holder">
                    <div class="client-slider owl-carousel">
                        <div class="client-item">
                            <img class="img-responsive" src="img/UNREAL.png" alt=" ">
                        </div>
                        <div class="client-item">
                            <img class="img-responsive" src="img/blender-svg.png" alt=" ">
                        </div>
                        <div class="client-item">
                            <img class="img-responsive" src="img/UNREAL.png" alt=" ">
                        </div>
